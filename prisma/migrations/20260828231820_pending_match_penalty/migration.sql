...
INSERT INTO "new_PlayerCareer" ("age", "createdAt", "currentClubId", "defense", "difficulty", "fitness", "foot", "id", "jerseyNumber", "lastName", "marketValueEUR", "mentality", "morale", "nationalityId", "ntAssists", "ntCaps", "ntGoals", "onLoanFromId", "overall", "pace", "passing", "physical", "position", "reputation", "seasonIndex", "shooting", "starterShare", "status", "updatedAt", "userId") SELECT "age", "createdAt", "currentClubId", "defense", "difficulty", "fitness", "foot", "id", "jerseyNumber", "lastName", "marketValueEUR", "mentality", "morale", "nationalityId", "ntAssists", "ntCaps", "ntGoals", "onLoanFromId", "overall", "pace", "passing", "physical", "position", "reputation", "seasonIndex", "shooting", "starterShare", "status", "updatedAt", "userId" FROM "PlayerCareer";
